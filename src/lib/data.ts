...
export const CROP_DATA: Crop[] = [
  ...
  },
  {
    ...
    description: 'Considerado el "viagra del Pacífico", el borojó es un fruto exótico de la región Pacífica colombiana, famoso por sus supuestas propiedades energizantes y afrodisíacas. Es un árbol de clima tropical húmedo.',
    difficulty: 'hard',
    lifeCycle: {
    ...
    requirements: {
      ...
      climate: 'Clima de selva tropical húmeda (24-30°C). No tolera el frío ni la sequía.',
      space: 'patio',
      pests: 'Pocas plagas significativas en su hábitat natural.',
      fertilizers: 'Exigente en materia orgánica. Requiere suelos ácidos y ricos.',
    },
    plantingGuide: {
      pot: [
        { text: 'Inviable. Es un árbol que necesita las condiciones específicas de la selva tropical.' },
        { text: 'Mantener la humedad requerida sería casi imposible.' },
        { text: 'No aplicable.' },
        { text: 'No aplicable.' },
      ],
      soil: [
        { text: 'Solo es posible en las condiciones del Chocó biogeográfico (Región Pacífica).' },
        { text: 'Requiere sombra parcial, imitando las condiciones del sotobosque.' },
        { text: 'El suelo debe ser muy rico en hojarasca y materia en descomposición.' },
        { text: 'Es un cultivo de nicho, no apto para huertos convencionales.' },
      ],
      hydroponics: [
        { text: 'No existe metodología para este cultivo.' },
        { text: 'Inviable.' },
        { text: 'No aplicable.' },
        { text: 'No aplicable.' },
      ],
    },
    compatibility: ['Árboles nativos de la selva tropical que le proporcionen sombra.'],
    incompatibility: ['Plantas de clima seco o que requieran pleno sol.'],
    warnings: 'Este es un cultivo extremadamente especializado y solo viable en la Región Pacífica de Colombia. No intentes cultivarlo en otros climas.',
    costs: {
      range: 'Alto',
      items: [
        { item: 'Plántulas (si se consiguen)', price: 'Variable y difícil de encontrar' },
      ],
      note: 'Más que un cultivo de huerto, es una especie para proyectos de reforestación o sistemas agroforestales en su región nativa.'
    },
    recommendations: 'La mejor forma de disfrutar el borojó es comprarlo en mercados locales de la región Pacífica y apoyar a las comunidades que lo cultivan tradicionalmente.',
    regions: ['Región Pacífica'],
    notifications: {
      irrigation: 'El {cropName} vive en la selva. ¡Necesita humedad todo el tiempo!',
    },
  },
  {
    id: 'chontaduro',
    ...
    description: 'El chontaduro es el fruto de una palmera, muy popular en la región Pacífica. Rico en grasas, proteínas y vitaminas, se consume cocido con sal o miel. Es un pilar de la seguridad alimentaria en su región.',
    difficulty: 'hard',
    lifeCycle: {
    ...
    requirements: {
      ...
      climate: 'Clima tropical húmedo y cálido (24-30°C).',
      space: 'patio',
      pests: 'Picudo de la palma, ácaros.',
      fertilizers: 'Exigente en nutrientes, especialmente potasio.',
    },
    plantingGuide: {
      pot: [
        { text: 'Inviable. Es una palmera que puede alcanzar gran altura.' },
        { text: 'No aplicable.' },
        { text: 'No aplicable.' },
        { text: 'No aplicable.' },
      ],
      soil: [
        { text: 'Requiere suelos profundos, fértiles y con buen drenaje.' },
        { text: 'Necesita mucho espacio para crecer, con distancias de 5x5 metros o más.' },
        { text: 'Se planta a pleno sol.' },
        { text: 'Es un cultivo a muy largo plazo, típico de sistemas agroforestales.' },
      ],
      hydroponics: [
        { text: 'Inviable para una palmera de este tamaño.' },
        { text: 'No aplicable.' },
        { text: 'No aplicable.' },
        { text: 'No aplicable.' },
      ],
    },
    compatibility: ['Cultivos de cobertura, cacao, plátano en sistemas agroforestales.'],
    incompatibility: ['Cultivos que no toleren sombra a medida que la palma crece.'],
    warnings: 'El tallo de la palmera está cubierto de espinas largas y afiladas. El manejo y la cosecha requieren mucho cuidado y equipo de protección.',
    costs: {
      range: 'Alto',
      items: [
        { item: 'Plántulas', price: 'Variable, puede ser difícil de conseguir fuera de su región.' },
      ],
      note: 'Es una inversión para fincas y grandes extensiones, no para un huerto casero.'
    },
    recommendations: 'Al igual que el borojó, el chontaduro es un tesoro cultural y gastronómico del Pacífico. La mejor manera de disfrutarlo es comprándolo a los productores locales.',
    regions: ['Región Pacífica', 'Región Amazonía'],
    notifications: {
      irrigation: 'Tu palmera de {cropName} necesita las lluvias del trópico. ¡Que no le falte agua!',
    },
  },
  {
    id: 'tomate-de-arbol',
    ...
    requirements: {
      ...
      climate: 'Clima frío moderado de altura (1,500 - 2,500 msnm).',
      space: 'garden',
      pests: 'Pulgones, mosca blanca, antracnosis.',
      fertilizers: 'Exigente en materia orgánica y nutrientes, especialmente fósforo y potasio.',
    },
    plantingGuide: {
      pot: [
        { text: 'Posible en macetas muy grandes (mínimo 40-50L) durante su vida productiva.' },
        { text: 'Requiere un sustrato muy rico y con buen drenaje.' },
        { text: 'Necesita un lugar soleado y con buena ventilación para evitar hongos.' },
        { text: 'La producción será menor que en suelo.' },
      ],
      soil: [
        { text: 'Planta en un sitio protegido del viento fuerte, ya que sus ramas son frágiles.' },
        { text: 'Deja un espacio de 2x2 metros entre plantas.' },
        { text: 'La poda de formación y sanitaria es importante para mantener la planta productiva y aireada.' },
        { text: 'Cosecha los frutos cuando tengan un color uniforme (rojo o amarillo, según la variedad).' },
      ],
      hydroponics: [
        { text: 'No es una práctica común, pero podría adaptarse a sistemas de goteo en sacos de sustrato.' },
        { text: 'El manejo de un arbusto de este tamaño en hidroponía es complejo.' },
        { text: 'No recomendado para principiantes.' },
        { text: 'Inviabilidad a nivel doméstico.' },
      ],
    },
    compatibility: ['Cultivos de bajo crecimiento que ayuden a cubrir el suelo.'],
    incompatibility: ['Papa, pimentón y otros miembros de la familia Solanaceae por plagas compartidas.'],
    warnings: 'El viento puede quebrar fácilmente las ramas, especialmente cuando están cargadas de frutos. Elige un lugar protegido.',
    costs: {
      range: 'Medio',
      items: [
        { item: 'Semillas/Plántulas', price: '$5,000 - $15,000 COP' },
        { item: 'Abono y fertilizantes', price: '$20,000 - $30,000 COP' },
      ],
    },
    recommendations: 'Es un arbusto de vida relativamente corta (4-5 años). Puedes ir germinando semillas nuevas para reemplazar las plantas viejas y mantener la producción.',
    regions: ['Región Andina'],
    notifications: {
      irrigation: 'Tu {cropName} necesita un riego equilibrado para frutos jugosos. ¡Ni mucho ni poco!',
    },
  },
  {
    id: 'pitahaya',
    name: 'Pitahaya (Fruta del Dragón)',
    species: 'Selenicereus undatus (blanca) / Hylocereus polyrhizus (roja)',
    description: 'La pitahaya es el fruto de un cactus trepador. Con su exótica apariencia y sabor dulce y refrescante, es una joya tropical. La planta requiere un soporte para trepar y florece de noche.',
    difficulty: 'medium',
    lifeCycle: {
    ...
    requirements: {
      ...
      climate: 'Clima cálido a templado. Necesita mucho sol.',
      space: 'patio',
      pests: 'Pocas plagas, a veces cochinillas o enfermedades fúngicas por exceso de humedad.',
      fertilizers: 'Materia orgánica al plantar y fertilizantes ricos en potasio durante la producción.',
    },
    plantingGuide: {
      pot: [
        { text: 'Funciona bien en macetas grandes (mínimo 30-40L) con un tutor central fuerte.' },
        { text: 'El sustrato debe tener un drenaje excelente, similar al de los cactus (mezcla con arena).' },
        { text: 'Coloca un poste de madera o tutor en el centro para que la planta trepe.' },
        { text: 'Riega solo cuando el sustrato esté completamente seco.' },
      ],
      soil: [
        { text: 'Requiere un sistema de soporte, tradicionalmente un poste de concreto o madera de unos 2 metros de alto.' },
        { text: 'Planta 2-3 esquejes en la base del poste.' },
        { text: 'A medida que crece, amarra los tallos al soporte hasta que lleguen a la cima.' },
        { text: 'La polinización nocturna la realizan polillas y murciélagos, pero a menudo se requiere polinización manual cruzada para una buena cosecha.' },
      ],
      hydroponics: [
        { text: 'No es una práctica común para este tipo de cactus.' },
        { text: 'El manejo del soporte y el control de la humedad serían muy complejos.' },
        { text: 'No aplicable.' },
        { text: 'No aplicable.' },
      ],
    },
    compatibility: ['Cultivos de bajo crecimiento que no compitan por el soporte.'],
    incompatibility: ['Cultivos que requieran mucha agua.'],
    warnings: 'La polinización puede ser el mayor desafío. Muchas variedades no son autopolinizantes, por lo que podrías necesitar dos plantas diferentes y polinizar a mano por la noche con un pincel.',
    costs: {
      range: 'Medio',
      items: [
        { item: 'Esquejes', price: '$10,000 - $25,000 COP' },
        { item: 'Poste de soporte', price: '$30,000 - $50,000 COP' },
      ],
    },
    recommendations: 'Empezar con esquejes es mucho más rápido y fácil que con semillas. Pide un trozo de tallo a alguien que ya tenga una planta. ¡Enraízan con mucha facilidad!',
    regions: ['Región Andina', 'Región Caribe', 'Región Orinoquía'],
    notifications: {
      irrigation: 'Tu {cropName} es un cactus. ¡Cuidado con el exceso de agua! Riega solo cuando esté bien seco.',
    },
  },
  {
    id: 'mora',
    name: 'Mora',
    species: 'Rubus glaucus',
    description: 'La mora andina es un arbusto espinoso y muy vigoroso que produce frutos ácidos y deliciosos, indispensables para jugos, postres y mermeladas en Colombia. Requiere manejo y podas constantes.',
    difficulty: 'medium',
    lifeCycle: {
    ...
    requirements: {
      ...
      climate: 'Clima frío a templado de altura (1,800 - 3,000 msnm).',
      space: 'garden',
      pests: 'Ácaros, pulgones, mosca de la fruta.',
      fertilizers: 'Exigente en materia orgánica y nutrientes. Responde bien a gallinaza o compost.',
    },
    plantingGuide: {
      pot: [
        { text: 'Difícil por su crecimiento vigoroso y espinoso. No recomendable.' },
        { text: 'Requeriría una maceta extremadamente grande y un manejo de podas muy estricto.' },
        { text: 'El rendimiento sería muy bajo.' },
        { text: 'Inviable para un huerto casero.' },
      ],
      soil: [
        { text: 'Requiere un sistema de espaldera o tutorado para guiar las ramas y facilitar la cosecha.' },
        { text: 'Planta a una distancia de 1.5 - 2 metros entre plantas.' },
        { text: 'La poda es la labor más importante: se eliminan las ramas que ya produjeron para dar paso a las nuevas.' },
        { text: 'Usa guantes gruesos para manipularla, sus espinas son muy agresivas.' },
      ],
      hydroponics: [
        { text: 'No es una práctica común para este tipo de arbusto.' },
        { text: 'Inviable debido a su tamaño, sistema de raíces y manejo de podas.' },
        { text: 'No aplicable.' },
        { text: 'No aplicable.' },
      ],
    },
    compatibility: ['Plantas de cobertura que no compitan por nutrientes.'],
    incompatibility: ['Cultivos que se vean ahogados por su crecimiento vigoroso.'],
    warnings: 'Las espinas son un problema serio. Planifica bien el sistema de soporte y usa siempre protección adecuada durante la poda y la cosecha.',
    costs: {
      range: 'Medio',
      items: [
        { item: 'Plántulas', price: '$8,000 - $20,000 COP' },
        { item: 'Sistema de espaldera', price: 'Variable, puede ser una inversión importante.' },
      ],
    },
    recommendations: 'Aprende bien la técnica de poda. La mora produce en las ramas del año. Las ramas viejas que ya dieron fruto deben ser eliminadas desde la base para estimular el crecimiento de nuevas ramas productivas.',
    regions: ['Región Andina'],
    notifications: {
      irrigation: 'Tus {cropName} necesitan agua para esos frutos jugosos. ¡Que no se sequen!',
    },
  },
  {
    id: 'feijoa',
    ...
    description: 'La feijoa es un arbusto o pequeño árbol de origen sudamericano, muy adaptado a la sabana de Bogotá. Produce un fruto aromático, de sabor único y con una pulpa gelatinosa. Sus flores también son comestibles.',
    difficulty: 'easy',
    lifeCycle: {
    ...
    requirements: {
      ...
      climate: 'Clima frío a templado (15-20°C). Tolera ligeras heladas.',
      space: 'garden',
      pests: 'Pocas plagas importantes, a veces mosca de la fruta.',
      fertilizers: 'No es muy exigente. Agradece la materia orgánica anual.',
    },
    plantingGuide: {
      pot: [
        { text: 'Se puede cultivar en macetas grandes (mínimo 50-70L) como arbusto ornamental.' },
        { text: 'La producción de fruta será limitada, pero posible.' },
        { text: 'Requiere pleno sol y podas regulares para mantener un tamaño manejable.' },
        { text: 'La poda ayuda a mantener una forma compacta y atractiva.' },
      ],
      soil: [
        { text: 'Es un arbusto muy rústico y de bajo mantenimiento una vez establecido.' },
        { text: 'Se puede usar como seto o pantalla visual en el jardín.' },
        { text: 'Planta a pleno sol, con una distancia de 3-4 metros si quieres que crezca como arbolito.' },
        { text: 'No recojas los frutos del árbol; espera a que caigan solos.' },
      ],
      hydroponics: [
        { text: 'No es un cultivo para hidroponía.' },
        { text: 'Inviable.' },
        { text: 'No aplicable.' },
        { text: 'No aplicable.' },
      ],
    },
    compatibility: ['Césped, plantas ornamentales de bajo crecimiento.'],
    incompatibility: ['Árboles grandes que le den demasiada sombra.'],
    warnings: 'La autopolinización puede ser pobre en algunas variedades. Plantar dos feijoas diferentes puede mejorar significativamente la producción de frutos.',
    costs: {
      range: 'Bajo',
      items: [
        { item: 'Planta de vivero', price: '$15,000 - $30,000 COP' },
      ],
    },
    recommendations: '¡Prueba los pétalos de las flores! Son carnosos, dulces y deliciosos en ensaladas. Es un arbusto muy noble, ideal para jardines de bajo mantenimiento en clima frío.',
    regions: ['Región Andina'],
    notifications: {
      irrigation: 'Tu {cropName} es resistente, pero un poco de agua durante las sequías le ayudará.',
    },
  },
  {
    id: 'calabaza',
    ...
    description: 'La calabaza es una planta rastrera que produce frutos grandes y de piel dura, ideales para almacenar durante el invierno. Su pulpa es dulce y se usa en sopas, purés y postres. Necesita mucho espacio.',
    difficulty: 'easy',
    lifeCycle: {
      planting: '7-10 días para germinar.',
      growth: '85-120 días hasta la cosecha.',
      harvest: 'Se cosecha en otoño, antes de las primeras heladas, cuando la piel está dura y el tallo seco.',
      totalDays: 120,
    },
    requirements: {
      irrigation: 'Riego profundo y espaciado. Evitar mojar las hojas.',
      climate: 'Clima cálido y mucho sol.',
      space: 'patio',
      pests: 'Pulgones, barrenador de la guía.',
      fertilizers: 'Muy exigente. Necesita un suelo muy rico en compost y materia orgánica.',
    },
    plantingGuide: {
      pot: [
        { text: 'Inviable para la mayoría de variedades por su gran tamaño. Solo variedades enanas "mini".' },
        { text: 'Se necesitaría un contenedor de más de 100 litros.' },
        { text: 'Inviable para un huerto casero.' },
        { text: 'No aplicable.' },
      ],
      soil: [
        { text: 'Siembra en montículos de tierra abonada, dejando 2-3 metros entre montículos.' },
        { text: 'Las guías pueden crecer muchos metros, así que planifica bien el espacio.' },
        { text: 'Colocar una tabla debajo de los frutos los protege de la pudrición.' },
        { text: 'Cosecha dejando un trozo de tallo en el fruto para mejorar su conservación.' },
      ],
      hydroponics: [
        { text: 'Inviable por el tamaño y peso de la planta y los frutos.' },
        { text: 'No aplicable.' },
        { text: 'No aplicable.' },
        { text: 'No aplicable.' },
      ],
    },
    compatibility: ['Maíz', 'Frijol', 'Menta'],
    incompatibility: ['Papa'],
    warnings: 'Asegúrate de tener espacio suficiente. Una sola planta puede tomarse una sección entera del jardín.',
    costs: {
      range: 'Bajo',
      items: [
        { item: 'Semillas', price: '$4,000 - $8,000 COP' },
    ...
    recommendations: 'La calabaza es perfecta para la asociación de "Las Tres Hermanas" con el maíz y el frijol. Sus grandes hojas protegen el suelo y mantienen a raya las malas hierbas.',
    regions: ['Región Andina', 'Región Caribe'],
    notifications: {
      irrigation: 'Tu {cropName} está formando frutos grandes. ¡Un riego profundo y regular es clave!',
    },
  },
  {
    id: 'guayaba',
    ...
    description: 'La guayaba es un árbol pequeño o arbusto grande que produce frutos muy aromáticos, ricos en vitamina C. Es una fruta muy popular en Colombia para jugos, bocadillos y consumo en fresco.',
    difficulty: 'easy',
    lifeCycle: {
    ...
    requirements: {
      ...
      climate: 'Clima cálido a templado. Tolera bien el calor.',
      space: 'garden',
      pests: 'Mosca de la fruta, picudos.',
      fertilizers: 'No es muy exigente, pero responde bien a fertilizantes balanceados.',
    },
    plantingGuide: {
      pot: [
        { text: 'Se pueden cultivar variedades enanas en macetas muy grandes (70L+).' },
        { text: 'Requiere pleno sol y podas regulares para mantener un tamaño manejable.' },
        { text: 'La producción de fruta será menor que en suelo.' },
        { text: 'Es una opción atractiva para patios grandes.' },
      ],
      soil: [
        { text: 'Es un árbol muy rústico y fácil de cuidar.' },
        { text: 'Planta a pleno sol, con buen drenaje.' },
        { text: 'La poda ayuda a mantener una estructura abierta que facilita la cosecha y reduce enfermedades.' },
        { text: 'Cosecha los frutos cuando ceden ligeramente a la presión y desprenden su aroma característico.' },
      ],
      hydroponics: [
        { text: 'No es un cultivo para hidroponía.' },
        { text: 'Inviable.' },
    ...
    compatibility: ['Plantas de cobertura, leguminosas.'],
    incompatibility: ['Cultivos que compitan fuertemente por luz y agua.'],
    warnings: 'La mosca de la fruta es su principal enemigo. Recoger y desechar los frutos caídos ayuda a controlar la plaga.',
    costs: {
      range: 'Bajo',
      items: [
        { item: 'Planta de vivero', price: '$15,000 - $35,000 COP' },
      ],
    },
    recommendations: 'La guayaba es un árbol excelente para un huerto familiar en clima cálido. Es productivo, resistente y sus frutos son deliciosos y versátiles.',
