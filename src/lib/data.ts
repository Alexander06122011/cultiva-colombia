...
export const CROP_DATA: Crop[] = [
  ...
  },
  {
    ...
    plantingGuide: {
      ...
      hydroponics: [
        { text: 'No es un cultivo ideal para hidroponía casera debido al desarrollo de la raíz.' },
  ...
  },
  {
    ...
    plantingGuide: {
      ...
      hydroponics: [
        { text: 'No es un cultivo común para sistemas hidropónicos caseros debido a su tamaño y ciclo largo.' },
